...
function buildArgs({ sessionFile, title, provider, model, thinkingLevel, readOnly, approve, theme }) {
  const args = ['--session', sessionFile, '--name', title || 'Web TUI', '--tui-mode', 'fullscreen', '--use-theme', normalizeTheme(theme)];
