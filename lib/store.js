...
export function createTask({ title, description, color, deadline, workingDir, workingDirs }) {
  ...
  const task = {
    ...
    workingDir: normalizedWorkingDirs[0] || null, workingDirs: normalizedWorkingDirs, model: null, modelProvider: null, thinkingLevel: null,
